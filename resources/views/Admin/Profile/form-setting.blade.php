    ...
    <form id="user-profile" method='POST'>
        ...
        <div class="form-group row align-items-center">
            ...
            <div class="col-sm-6 col-md-9">
                <input type="text" id="name" name="name"  class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" require value="{{\Auth::user()->name}}">
        ...
        <div class="form-group row align-items-center">
            ...
            <div class="col-sm-6 col-md-9">
                <input type="text" id="username" name="username"  class="form-control {{ $errors->has('username') ? ' is-invalid' : '' }}" require value="{{\Auth::user()->username}}">
                <div class="invalid-feedback">
